...
<body class="gray container-fluid" style="background-image: url({{asset('images/plantilla/fondo.png')}}); background-repeat: no-repeat; background-color: #cccccc;  background-position: center;  background-size: cover; /* Resize the background image to cover the entire container */">
<!-- div de lluvia-->
...
<div>
    <div class="row flex-nowrap">
        <div id="menu_2" class="col-auto px-sm-2 px-0 bg-dark" style="padding: 0px !important; min-width: 160px;">
            <div class="d-flex flex-column align-items-center align-items-sm-start text-white min-vh-100" style="background-color: #343a3f; max-width: 160px;">
                <div id="head_menu" style="width:100%; display: flex; justify-content: center; align-items: center">
                    ...
                    <img id="img_logo" src={{asset('images/plantilla/logo1.png')}}>
        ...
        <div class="col p-0" style="overflow: auto;">
            <div id="header-main" class="p-1" style="background: linear-gradient(149deg,#991d81 10%,#e73c45 100%);">
                <div id="boton_menu" style="width: min-content;">
                    <img src={{asset('images/plantilla/menu_icon.png')}} style="width: 15px; height: 15px; vertical-align: initial;">
                </div>
            </div>
