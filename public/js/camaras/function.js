link_camaras.function = {


    fill_table_camaras: function (data) {

        link_camaras.tabla_camaras = $('#table_camaras').DataTable( {
            data: data,
            columns: [
                { data: 'no_serie' },
                { data: 'modelo.marca.nombre_marca' },
                { data: 'estatus' },
        ...
        link_camaras.function.selected_row("#table_camaras");
    ...
    selected_row: function (id_table) {
        $(id_table + " tbody").off().on("click", "tr", function () {
            ...
            if (rowData.data() !== undefined) {
                link_camaras.data = rowData.data();
                r = link_camaras.data;
                ...
                if(id_table=="#table_camaras"){
                    $("#delete_cam").show();
                    $(".btn-cam-select").hide();
                    link_camaras.function.modal_cam_per();
